...
class CADModelsCustom():
    def __init__(self, data_dir=None):
        if data_dir is None:
            data_dir = os.path.join(get_yolox_datadir(), "MyDataset")
        ...
        self.symmetric_objects = { 0 : "mask"}

    def get_camera_params(self):
        camera_params_paths = [os.path.join(self.data_dir, "camera_1.json"),
                                os.path.join(self.data_dir, "camera_2.json"),
                                os.path.join(self.data_dir, "camera_3.json"),
                                os.path.join(self.data_dir, "camera_4.json")]
        camera_matrix = {}
...
class CustomDataset(Dataset):
    ...
    def __init__(
        ...
        self.cad_models = CADModelsCustom()
    ...
    def load_anno_from_ids(self, id_):
        ...
        for ix, obj in enumerate(objs):
            ...
            if self.object_pose:
                ...
                camera_matrix = self.cad_models.camera_matrix[f'camera_{image_folder}']
                obj_centre_2d = np.matmul(camera_matrix.reshape(3,3), np.array(obj["T"])/obj["T"][2])[:2]
        ...
        res[:, :4] *= r
        # This is also critical: scale the projected 2D center by the resize ratio
        res[:, -3:-1] *= r
    ...
    def pull_item(self, index):
        ...
        # Apply the fix using the convention you found
